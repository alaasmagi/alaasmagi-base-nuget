    ...
    where TActor : IEquatable<TActor>
{
    ...
    /// </returns>
    Task<IMethodResponse<bool>> SoftDeleteAsync(TResourceKey id, string? expectedConcurrencyToken = default, TActor? actor = default!);
    ...
    /// </returns>
    Task<IMethodResponse<TEntity>> RestoreAsync(TResourceKey id, string? expectedConcurrencyToken = default, TActor? actor = default!);
}

    ...
    where TActor : IEquatable<TActor>
{
    ...
    /// </returns>
    Task<IMethodResponse<TEntity>> UpdateAsync(TResourceKey id, TEntity entity, string? expectedConcurrencyToken = default, TActor? actor = default!);
    ...
    /// </returns>
    Task<IMethodResponse<bool>> RemoveAsync(TResourceKey id, string? expectedConcurrencyToken = default, TActor? actor = default!);
}

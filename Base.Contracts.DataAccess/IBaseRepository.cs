...
/// <summary>
/// Defines a base repository contract for entities that use <see cref="Guid"/> as both the entity key and user key.
/// </summary>
...
public interface IBaseRepository<TEntity, TResourceKey, TUserKey>
    where TEntity : class
    ...
    where TUserKey : IEquatable<TUserKey>
{
    ...
    /// <summary>
    /// Retrieves a single page of entities visible to the specified user.
    /// </summary>
    ...
    /// <summary>
    /// Counts all entities visible to the specified user.
    /// </summary>
    /// <param name="userId">The optional user identifier used to scope the query.</param>
    /// <returns>
